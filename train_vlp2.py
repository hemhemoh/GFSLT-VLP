...
def main(args, config):
    ...
    # if args.distributed:
    #the line below is meant to be indented, line 241 is meant to have .module before.parameter
...
def train_one_epoch(args, model: torch.nn.Module, criterion: nn.CrossEntropyLoss,
    ...
    for step, (src_input, tgt_input, masked_tgt_input) in enumerate(metric_logger.log_every(data_loader, print_freq, header)):
        ...
        if step % 5 == 0:
            ...
            with torch.cuda.amp.autocast():
                lm_logits = TD_train_dict['text_decoder'](tgt_input, masked_tgt_input, model.model_txt) #.module.model_txt 
